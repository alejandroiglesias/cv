  ...
  roles: [
    // ─── Featured roles ──────────────────────────────────────────
    {
      ...
      bullets: [
        ...
        'Collaborated closely with backend, design, QA, and marketing to define and deliver product and technical solutions.',
        'Proactively identified UX, product, and implementation opportunities, contributing practical improvements beyond assigned work.',
        'Implemented new backend API endpoints in Node.js and Express to support frontend features within a microservices-based architecture.',
        'Worked within a microservices-based architecture using a custom internal frontend framework, alongside Node.js and Express.',
      ],
    },
    {
      company: 'BairesDev',
      ...
      featured: true,
      bullets: [
        "Worked across Pinterest's Experiments and Monetization teams, contributing to both the core product UI and internal reporting tools.",
        ...
        'Took ownership of the UI layer for reporting tools, defining information architecture and data presentation.',
        'Adapted to backend responsibilities, learning Go and implementing APIs to support frontend needs.',
        'Worked across frontend and backend to deliver end-to-end functionality.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Collaborated closely with the CTO and worked directly with the CEO on UI and UX decisions, translating business needs into practical, user-friendly solutions.',
